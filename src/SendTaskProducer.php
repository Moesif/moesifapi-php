...
class SendTaskProducer extends BaseClass {
    ...
    protected function _getConsumer() {
        ...
        $this->_options['app_config_endpoint'] = $this->_getAppConfigEndpoint();
        $this->_options['event_endpoint'] = $this->_getEventEndpoint();
    ...
    public function getAppConfig() {
        return $this->_consumer->getAppConfig();
    }
    ...
    public function createEvent($eventData) {
        return $this->_consumer->createEvent($eventData);
    }
    ...
    public function _getAppConfigEndpoint() {
        return '/v1/config';
    }
    ...
    public function _getEventEndpoint() {
        return '/v1/events';
    }
