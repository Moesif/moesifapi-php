...
class ApiControllerTest extends PHPUnit_Framework_TestCase {
    ...
    {
        $client = new MoesifApi\MoesifApiClient();
    ...
    public function testAddEvent() {
        ...
        $this->assertCount(count($headers), $this->httpResponse->getResponse()->getHeaders(),
